...
import org.uzlocoinj.params.AbstractBitcoinNetParams;
...
public class UzlocoinURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.uzlocoinj.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.uzlocoinj.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    /**
     * Constructs a new UzlocoinURI from the given string. Can be for any network.
     *
     ...
     */
    public UzlocoinURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public UzlocoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("UzlocoinURI[");
        boolean first = true;
