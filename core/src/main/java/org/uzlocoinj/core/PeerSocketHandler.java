...
import org.uzlocoinj.net.AbstractTimeoutHandler;
import org.uzlocoinj.net.MessageWriteTarget;
 ...
 * {@link org.uzlocoinj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
     ...
     * called automatically by {@link org.uzlocoinj.net.NioClient} or
     * {@link org.uzlocoinj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
