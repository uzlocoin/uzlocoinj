 ...
 * the lightweight SPV mode, a {@link org.uzlocoinj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.uzlocoinj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
