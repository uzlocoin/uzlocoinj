...
import org.uzlocoinj.net.discovery.HttpDiscovery;
import org.uzlocoinj.params.*;
import org.uzlocoinj.script.Script;
import org.uzlocoinj.script.ScriptBuilder;
import org.uzlocoinj.script.ScriptChunk;
import org.uzlocoinj.script.ScriptOpCodes;
import org.uzlocoinj.store.BlockStore;
import org.uzlocoinj.store.BlockStoreException;
import org.uzlocoinj.utils.MonetaryFormat;
...
import org.uzlocoinj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.uzlocoinj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.uzlocoinj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.uzlocoinj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.uzlocoinj.core.AlertMessage}s. You can use {@link org.uzlocoinj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
