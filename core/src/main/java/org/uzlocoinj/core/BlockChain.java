...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link org.uzlocoinj.store.SPVBlockStore} or you could also try a
     * {@link org.uzlocoinj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
