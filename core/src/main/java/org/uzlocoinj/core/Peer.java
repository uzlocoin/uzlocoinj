...
import org.uzlocoinj.net.StreamConnection;
import org.uzlocoinj.store.BlockStore;
import org.uzlocoinj.store.BlockStoreException;
import org.uzlocoinj.utils.ListenerRegistration;
 ...
 * {@link org.uzlocoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.uzlocoinj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.uzlocoinj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.uzlocoinj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.uzlocoinj.core.TxConfidenceTable}
...
//            if(!instantSend.mapTxLockVotes.containsKey(item.hash))
     ...
     * Once the pong is received the value returned by {@link org.uzlocoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.uzlocoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.uzlocoinj.core.Peer#ping()} has never
