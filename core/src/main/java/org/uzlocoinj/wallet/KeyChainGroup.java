...
/**
 * <p>A KeyChainGroup is used by the {@link org.uzlocoinj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.uzlocoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.uzlocoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.uzlocoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
