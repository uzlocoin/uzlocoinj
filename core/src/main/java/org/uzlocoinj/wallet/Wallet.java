...
import org.uzlocoinj.core.*;
import org.uzlocoinj.core.Message;
import org.uzlocoinj.core.listeners.*;
import org.uzlocoinj.core.TransactionConfidence.*;
import org.uzlocoinj.crypto.*;
import org.uzlocoinj.script.*;
import org.uzlocoinj.signers.*;
import org.uzlocoinj.utils.*;
import org.uzlocoinj.wallet.Protos.Wallet.*;
import org.uzlocoinj.wallet.WalletTransaction.*;
import org.uzlocoinj.wallet.listeners.KeyChainEventListener;
import org.uzlocoinj.wallet.listeners.ScriptsChangeEventListener;
import org.uzlocoinj.wallet.listeners.WalletChangeEventListener;
import org.uzlocoinj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.uzlocoinj.wallet.listeners.WalletCoinsSentEventListener;
import org.uzlocoinj.wallet.listeners.WalletEventListener;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.uzlocoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
    ...
    private Wallet(Context context, KeyChainGroup keyChainGroup) {
        ...
        //this.version = this.keyChainGroup.getActiveKeyChain().getKeyChainType() == DeterministicKeyChain.KeyChainType.BIP44_UZLOCOIN_ONLY? 1 : 0;
     ...
     * {@link org.uzlocoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.uzlocoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.uzlocoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.uzlocoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.uzlocoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.uzlocoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.uzlocoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.uzlocoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.uzlocoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.uzlocoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.uzlocoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.uzlocoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.uzlocoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.uzlocoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.uzlocoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.uzlocoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.uzlocoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.uzlocoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.uzlocoinj.crypto.KeyCrypter,
     ...
     * {@link org.uzlocoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.uzlocoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.uzlocoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.uzlocoinj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.uzlocoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.uzlocoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
