...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.uzlocoinj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.uzlocoinj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(org.uzlocoinj.crypto.KeyCrypter,
