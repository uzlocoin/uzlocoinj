...
import org.uzlocoinj.crypto.KeyCrypterException;
...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(org.uzlocoinj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link org.uzlocoinj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link org.uzlocoinj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
