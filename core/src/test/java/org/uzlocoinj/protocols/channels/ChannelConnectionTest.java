...
import static org.uzlocoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.uzlocoinj.testing.FakeTxBuilder.createFakeBlock;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private Semauzlocoin broadcastTxPause;
    ...
    public void setUp() throws Exception {
        ...
        // to the broadcastTxPause semauzlocoin so state can be queried in between.
        broadcasts = new LinkedBlockingQueue<Transaction>();
        broadcastTxPause = new Semauzlocoin(0);
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.uzlocoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
