...
import org.uzlocoinj.crypto.LazyECPoint;
import org.uzlocoinj.crypto.MnemonicCode;
import org.uzlocoinj.crypto.MnemonicException;
import org.uzlocoinj.net.discovery.PeerDiscovery;
import org.uzlocoinj.net.discovery.PeerDiscoveryException;
...
public class MatiTest {
    ...
    public void accountDetailsTest(){
        ...
        Wallet wallet = Wallet.fromSeed(
                networkParameters,
                seed,
                DeterministicKeyChain.KeyChainType.BIP44_UZLOCOIN_ONLY
        );
    ...
    public void watchOnlyTest(){
        ...
        Wallet watchingWallet = Wallet.fromWatchingKeyB58(networkParameters,xpub,0, DeterministicKeyChain.KeyChainType.BIP44_UZLOCOIN_ONLY);
